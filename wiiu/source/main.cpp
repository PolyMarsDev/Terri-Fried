...
int LoadHighScore() {
    FILE *scorefile = fopen("fs:/vol/external01/Terri-Fried/terri-fried-score.bin", "rb");
...
void SaveHighScore(int val) {
    FILE *scorefile = fopen("fs:/vol/external01/Terri-Fried/terri-fried-score.bin", "wb");
...
int main(int argc, char **argv) {
    ...
    SDL_Window* window = SDL_CreateWindow("Terri-Fried", SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, screenWidth, screenHeight, SDL_WINDOW_FULLSCREEN_DESKTOP);
    ...
    while (WHBProcIsRunning()) {
        ...
        if (titleScreen) {
            ...
            SDL_Rect lavaSprite_rect = { 0, lavaY, 1280, 48 };
