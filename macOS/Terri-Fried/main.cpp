...
int main(int argc, char **argv) {
    ...
    Mix_Chunk* fxLaunch = Mix_LoadWAV("/Users/yinuowang/Terri-Fried/linux/Terri-Fried/Terri-Fried/resources/launch.wav");
    Mix_Chunk* fxClick = Mix_LoadWAV("/Users/yinuowang/Terri-Fried/linux/Terri-Fried/Terri-Fried/resources/click.wav");
    Mix_Chunk* fxDeath = Mix_LoadWAV("/Users/yinuowang/Terri-Fried/linux/Terri-Fried/Terri-Fried/resources/die.wav");
    Mix_Chunk* fxCoin = Mix_LoadWAV("/Users/yinuowang/Terri-Fried/linux/Terri-Fried/Terri-Fried/resources/coin.wav");
    Mix_Chunk* fxSplash = Mix_LoadWAV("/Users/yinuowang/Terri-Fried/linux/Terri-Fried/Terri-Fried/resources/splash.wav");
    Mix_Chunk* fxSelect = Mix_LoadWAV("/Users/yinuowang/Terri-Fried/linux/Terri-Fried/Terri-Fried/resources/select.wav");
    ...
    while (!quit) {
        ...
        if (titleScreen) {
            if (splashTimer > 120) {
                ...
                SDL_Color col = {0,0,0};
                Draw_Font(renderer, highscore, screenWidth/2 - 37, screenHeight/2 + 10, 74, 32, 32, col);
                SDL_Color col2 = {178,150,125};
                Draw_Font(renderer, "CLICK ANYWHERE TO BEGIN", screenWidth/2 - 134, screenHeight/2 + 50, 268, 32, 32, col2);
                ...
                SDL_Color col3 = {213,128,90};
                Draw_Font(renderer, "POLYMARS", screenWidth/2 - 54, screenHeight/2 + 3, 108, 32, 32, col3);
            ...
            SDL_Color col = {0,0,0};
            Draw_Font(renderer, score, 28, 20, 75, 64, 64, col);
            Draw_Font(renderer, highscore, 17, 90, 74, 32, 32, col);
